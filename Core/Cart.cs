...
namespace Core
{
    public class Cart
    {
        ...
        public string ToHtml(string CssClass)
        {
            ...
            {
                //"<tr class='itemRow'><td class='productId'>{0}</td><td>{1}</td><td>{2:C}</td><td><input class='quantityInput' type='number' min='1' maxlength='3' value='{3}' /></td><td class='extendedPrice'>{4:C}</td><td><a href='/RemoveFromCart.aspx?ProductId={0}'>remove</a></td></tr>",
                sb.AppendFormat(
                     "<tr class='itemRow'><td class='productId'>{0}</td><td>{1}</td><td>{2:C}</td><td>{3}</td><td class='extendedPrice'>{4:C}</td><td><a href='/RemoveFromCart.aspx?ProductId={0}'>remove</a></td></tr>",

...
namespace Core
{
    public class CreditCard
    {
        ...
        public void GetCardForUser()
        {
            ...
            catch (IndexOutOfRangeException ex)     //File exists but has nothing in in.
            {
                CreateNewCreditCardFile();
            }
            catch (XmlException ex)     //File is corrupt. Delete and recreate.
            {
                CreateNewCreditCardFile();
            }
            catch (NullReferenceException ex)   //The row was not found.
            {
        ...
        private XDocument ReadCreditCardFile()
        {
            ...
            catch (FileNotFoundException ex)    //File does not exist - Create it.
            {
                CreateNewCreditCardFile();
            }
            catch (IndexOutOfRangeException ex)     //File exists but has nothing in in.
